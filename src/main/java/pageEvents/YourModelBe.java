...
public class YourModelBe extends BaseTest{
	ElementFetch ele = new ElementFetch();
	public void uploadModel() throws InterruptedException, IOException, AWTException {
        ...
        StringSelection filePath = new StringSelection(uploadModelBeElements.fileLocation);
        ...
        Thread.sleep(10000); 
        driver.findElement(By.xpath("//button[text()='Your Designs']")).click();
        Thread.sleep(8000); 
